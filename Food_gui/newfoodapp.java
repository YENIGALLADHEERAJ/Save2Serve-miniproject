    ...
    private static void handleLogin(String username, String password, String role) {
        ...
        if (user != null) {
            ...
            if (role.equalsIgnoreCase("collector")) {
                Collector collector = new Collector(user.getUsername(), user.getPassword(), user.getName());
                showCollectorMenu(collector);
            } else if (role.equalsIgnoreCase("provider")) {
                Provider provider = new Provider(user.getUsername(), user.getPassword(), user.getName(), "P" + user.getUsername());
