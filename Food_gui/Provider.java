...
public class Provider extends User {
    ...
    private boolean saveWastedItemToDatabase(WastedItem item) {
        String sql = "INSERT INTO wasted_items (provider_username, food_item_name, quantity, unit, waste_date) VALUES (?, ?, ?, ?, ?)";
    ...
    public void loadWastedItemsFromDatabase() {
        String sql = "SELECT food_item_name, quantity, unit, waste_date FROM wasted_items WHERE provider_username = ?";
