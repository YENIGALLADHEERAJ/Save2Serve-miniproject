...
public class ProviderPortal {
    // SQL query constants
    private static final String SELECT_ALL_WASTED_ITEMS = 
        "SELECT food_item_name, quantity, waste_date, provider_username " +
        "FROM wasted_items";
    private static final String INSERT_WASTED_ITEM = 
        "INSERT INTO wasted_items (provider_username, food_item_name, quantity, unit) " +
        "VALUES (?, ?, ?, ?)";
    ...
    private void loadAllWastedItemsFromDatabase(JTextArea itemsArea) {
        try (Connection connection = DatabaseConnection.getConnection();
            ...
            while (resultSet.next()) {
                ...
                LocalDate dateWasted = resultSet.getDate("waste_date").toLocalDate();
    ...
    private void addWastedItemToDatabase(String providerUsername, String foodItemName, int quantity, String unit) throws SQLException {
        ...
        try {
            ...
            try (PreparedStatement statement = connection.prepareStatement(INSERT_WASTED_ITEM)) {
